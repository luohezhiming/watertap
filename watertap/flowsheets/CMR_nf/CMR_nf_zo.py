...
def build(case, simplified_routine=False):
    ...
    m.fs.costing.add_LCOW(m.fs.unit.properties_permeate[0].flow_vol)
...
def set_scaling(m):
    ...
    set_scaling_factor(m.fs.unit.inlet.flow_mol_phase_comp[0, "Liq", "Co_2+"], 1e2)
    set_scaling_factor(m.fs.unit.inlet.flow_mol_phase_comp[0, "Liq", "Ca_2+"], 1e2)
    set_scaling_factor(m.fs.unit.inlet.flow_mol_phase_comp[0, "Liq", "Cu_2+"], 1e2)
    set_scaling_factor(m.fs.unit.inlet.flow_mol_phase_comp[0, "Liq", "Fe_3+"], 1e0)
    set_scaling_factor(m.fs.unit.inlet.flow_mol_phase_comp[0, "Liq", "Nd_3+"], 1e2)
    set_scaling_factor(m.fs.unit.inlet.flow_mol_phase_comp[0, "Liq", "Ni_2+"], 1e2)
    set_scaling_factor(m.fs.unit.inlet.flow_mol_phase_comp[0, "Liq", "Pr_3+"], 1e2)
    set_scaling_factor(m.fs.unit.inlet.flow_mol_phase_comp[0, "Liq", "Na_+"], 1e2)
    set_scaling_factor(m.fs.unit.inlet.flow_mol_phase_comp[0, "Liq", "Cr_6+"], 1e2)
    set_scaling_factor(m.fs.unit.inlet.flow_mol_phase_comp[0, "Liq", "Sn_2+"], 1e2)
...
def display_costing(m):
    ...
    print(
        "capital cost nanofiltration",
        pyo.value(m.fs.unit.costing.capital_cost),
        pyo.units.get_units(m.fs.unit.costing.capital_cost),
    )


if __name__ == "__main__":
    m, results = CMR_nf_case(case=Case.case2, simplified_routine=False)

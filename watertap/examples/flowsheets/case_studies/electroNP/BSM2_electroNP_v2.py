...
def set_operating_conditions(m):
    ...
    m.fs.FeedWater.conc_mass_comp[0, "S_A"].fix(40 * pyo.units.g / pyo.units.m**3)
    ...
    m.fs.FeedWater.conc_mass_comp[0, "X_PAO"].fix(20 * pyo.units.g / pyo.units.m**3)
        ...
        stream_table = create_stream_table_dataframe(
            {
                ...
                "ASM2d-ADM1 inlet": m.fs.translator_asm2d_adm1.inlet,
                "R1": m.fs.R1.outlet,
                # "R2": m.fs.R2.outlet,
                # "R3": m.fs.R3.outlet,
                # "R4": m.fs.R4.outlet,
